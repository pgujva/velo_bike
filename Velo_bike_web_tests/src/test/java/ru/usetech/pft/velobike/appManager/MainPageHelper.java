...
public class MainPageHelper {
  ...
  public List<PricePageData> getStaticPriceList() {
   ...
   // prices.add(1, pricePageData1);
    ...
    PricePageData pricePageData1 = new PricePageData("Месяц",
            "Включает поездки\nдо 30 минут",
            "600 \u20BD", "https://velobike.ru/media/content/ratedescription/icon/d2/9c/d29c50e2-dac9-4305-970e-190c903ab465.png", null);
    prices.add(1, pricePageData1);

    PricePageData pricePageData2 = new PricePageData("Сезон",
            "Включает поездки\nдо 30 минут",
            "700 \u20BD", "https://velobike.ru/media/content/ratedescription/icon/be/2b/be2b119b-432e-4318-8d33-9bfe61055e7c.png", null);
    prices.add(2, pricePageData2);

    PricePageData pricePageData3 = new PricePageData("Сезон. 45 мин.",
            "Включает поездки\nдо 45 минут",
            "800 \u20BD", "https://velobike.ru/media/content/ratedescription/icon/c3/b1/c3b18242-c487-4911-9b71-1facefd0229a.png", null);
